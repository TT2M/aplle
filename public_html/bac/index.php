...
require __DIR__ . '/../../yii-application/backend/config/bootstrap.php';
...
$config = yii\helpers\ArrayHelper::merge(
    ...
    require __DIR__ . '/../../yii-application/backend/config/main.php',
    require __DIR__ . '/../../yii-application/backend/config/main-local.php'
);
